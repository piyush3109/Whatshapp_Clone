...
const SettingItem = ({ icon: Icon, title, noBorder }) => (
    ...
    <div className="bg-black text-white min-h-screen pb-20 font-sans">
      ...
      <div className="px-4 mt-6">
        ...
        <div className="rounded-xl overflow-hidden mb-8">
          <SettingItem icon={UserCircle2} title="Avatar" />
          <SettingItem icon={ListMinus} title="Lists" />
          <SettingItem icon={Megaphone} title="Broadcast messages" />
          <SettingItem icon={Star} title="Starred" />
          <SettingItem icon={Laptop} title="Linked devices" noBorder />
        </div>

        {/* Section 2 */}
        <div className="rounded-xl overflow-hidden mb-8">
          <SettingItem icon={KeyRound} title="Account" />
          <SettingItem icon={Lock} title="Privacy" />
          <SettingItem icon={MessageCircle} title="Chats" />
          <SettingItem icon={Bell} title="Notifications" />
          <SettingItem icon={CreditCard} title="Payments" />
          <SettingItem icon={ArrowDownUp} title="Storage and data" noBorder />
        </div>

        {/* Section 3 */}
        <div className="rounded-xl overflow-hidden mb-8">
          <SettingItem icon={HelpCircle} title="Help and feedback" />
          <SettingItem icon={UserPlus} title="Invite a friend" noBorder />
        </div>
